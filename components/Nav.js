...
const Nav = () => {
  ...
  return (
    <header className={`${navStyles["primary-header"]} flex`}>
      <div className={`${navStyles["left-header-div"]} flex`}>
        {!isBreakPoint ? (
          <>
            <button
              className={
                !showMobileNav
                  ? `${navStyles["mobile-menu"]} ${navStyles["mobile-menu__hamburger"]}`
                  : `${navStyles["mobile-menu"]} ${navStyles["mobile-menu__close"]}`
              }
              onClick={toggleMobileNav}
            />
            <svg
              className={`${navStyles["brand-logo"]}`}
              width="138"
              height="20"
            ...
            <nav
              id="nav-modal"
              className={`${navStyles["primary-navigation-mobile"]}`}
            >
              <ul className={`${navStyles["mobile-nav__list"]}`}>
                <li className={`${navStyles["mobile-nav__item"]}`}>
                  <Link href={`/`}>
                    <a>Collections</a>
                  </Link>
                </li>
          ...
          <>
            ...
            <nav className={`${navStyles["primary-navigation"]}`}>
      ...
      <div className={`${navStyles["right-header-div"]} flex`}>
        ...
        <div className={`${navStyles["avatar-container"]}`}>
          <Image
            alt={`profile picture`}
            src={avatarPic}
            layout={"responsive"}
